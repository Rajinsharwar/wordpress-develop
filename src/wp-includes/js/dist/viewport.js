...
const withViewportMatch = queries => {
  ...
  const useViewPortQueriesResult = () => Object.fromEntries(queryEntries.map(([key, query]) => {
    ...
    return [key, (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.useViewportMatch)(breakpointName, operator)];
  }));

  return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(WrappedComponent => {
    return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.pure)(props => {
