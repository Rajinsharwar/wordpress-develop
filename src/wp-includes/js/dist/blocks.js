...
/* harmony export */   "isUnmodifiedBlock": function() { return /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_10__.isUnmodifiedBlock; },
...
const toBooleanAttributeMatcher = matcher => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pipe)([matcher, // Expected values from `attr( 'disabled' )`:
//
// <input>
// - Value:       `undefined`
// - Transformed: `false`
...
const matcherFromSource = (0,memize__WEBPACK_IMPORTED_MODULE_1__["default"])(sourceConfig => {
  switch (sourceConfig.source) {
    ...
    case 'tag':
      return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pipe)([(0,hpq__WEBPACK_IMPORTED_MODULE_0__.prop)(sourceConfig.selector, 'nodeName'), nodeName => nodeName ? nodeName.toLowerCase() : undefined]);
...
function htmlToBlocks(html, handler) {
  ...
  return Array.from(doc.body.children).flatMap(node => {
    const rawTransform = (0,_factory__WEBPACK_IMPORTED_MODULE_0__.findTransform)((0,_get_raw_transforms__WEBPACK_IMPORTED_MODULE_1__.getRawTransforms)(), ({
      isMatch
    }) => isMatch(node));
...
/* harmony export */   "pasteHandler": function() { return /* reexport safe */ _paste_handler__WEBPACK_IMPORTED_MODULE_2__.pasteHandler; },
...
/* harmony import */ var _is_inline_content__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./is-inline-content */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/is-inline-content.js");
...
/* harmony import */ var _ms_list_converter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ms-list-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/ms-list-converter.js");
...
/* harmony import */ var _shortcode_converter__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./shortcode-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/shortcode-converter.js");
...
function filterInlineHTML(HTML, preserveWhiteSpace) {
  HTML = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.deepFilterHTML)(HTML, [_head_remover__WEBPACK_IMPORTED_MODULE_2__["default"], _google_docs_uid_remover__WEBPACK_IMPORTED_MODULE_3__["default"], _phrasing_content_reducer__WEBPACK_IMPORTED_MODULE_4__["default"], _comment_remover__WEBPACK_IMPORTED_MODULE_5__["default"]]);
  ...
  if (!preserveWhiteSpace) {
    HTML = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.deepFilterHTML)(HTML, [_html_formatting_remover__WEBPACK_IMPORTED_MODULE_6__["default"], _br_remover__WEBPACK_IMPORTED_MODULE_7__["default"]]);
...
function pasteHandler({
  ...
  if (plainText && (!HTML || (0,_utils__WEBPACK_IMPORTED_MODULE_1__.isPlain)(HTML))) {
  ...
  HTML = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.deepFilterHTML)(HTML, [_slack_paragraph_corrector__WEBPACK_IMPORTED_MODULE_10__["default"]]); // An array of HTML strings and block objects. The blocks replace matched
  // shortcodes.

  const pieces = (0,_shortcode_converter__WEBPACK_IMPORTED_MODULE_11__["default"])(HTML); // The call to shortcodeConverter will always return more than one element
  // if shortcodes are matched. The reason is when shortcodes are matched
  // empty HTML strings are included.

  const hasShortcodes = pieces.length > 1;

  if (mode === 'AUTO' && !hasShortcodes && (0,_is_inline_content__WEBPACK_IMPORTED_MODULE_12__["default"])(HTML, tagName)) {
    return filterInlineHTML(HTML, preserveWhiteSpace);
  }
  ...
  if (mode === 'AUTO' && blocks.length === 1 && (0,_registration__WEBPACK_IMPORTED_MODULE_24__.hasBlockSupport)(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return (0,_wordpress_dom__WEBPACK_IMPORTED_MODULE_0__.removeInvalidHTML)((0,_serializer__WEBPACK_IMPORTED_MODULE_25__.getBlockInnerHTML)(blocks[0]), phrasingContentSchema).replace(trimRegex, '');
    }
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ slackParagraphCorrector; }
/* harmony export */ });
/**
...
function moreCommentConverter(node, doc) {
  ...
  if (!node.parentNode || node.parentNode.nodeName !== 'P' || node.parentNode.childNodes.length === 1) {
    (0,_wordpress_dom__WEBPACK_IMPORTED_MODULE_0__.replace)(node, moreBlock);
  } else {
...
const customMerge = key => {
  return (srcValue, objValue) => {
    ...
    return deepmerge__WEBPACK_IMPORTED_MODULE_0___default()(objValue, srcValue, {
      customMerge,
      clone: false
    });
  };
...
function getBlockContentSchemaFromTransforms(transforms, context) {
  ...
  return deepmerge__WEBPACK_IMPORTED_MODULE_0___default().all(schemas, {
    customMerge,
    clone: false
  });
}
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store */ "./node_modules/@wordpress/blocks/build-module/store/index.js");
...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = Object.fromEntries(Object.entries(definitions[blockName]).filter(([, value]) => value !== null && value !== undefined).map(([key, value]) => [(0,change_case__WEBPACK_IMPORTED_MODULE_3__.camelCase)(key), value]));
  }
}
/**
...
function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockType(name)) {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).__experimentalRegisterBlockType(blockType);

  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockType(name);
}
/**
...
function registerBlockCollection(namespace, {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).addBlockCollection(namespace, title, icon);
}
/**
...
function unregisterBlockCollection(namespace) {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).removeBlockCollection(namespace);
}
/**
 * Unregisters a block.
 *
...
function unregisterBlockType(name) {
  const oldBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockType(name);
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).removeBlockTypes(name);
  return oldBlock;
}
/**
...
function setFreeformContentHandlerName(blockName) {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setFreeformFallbackBlockName(blockName);
}
/**
...
function getFreeformContentHandlerName() {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getFreeformFallbackBlockName();
}
/**
...
function getGroupingBlockName() {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getGroupingBlockName();
}
/**
...
function setUnregisteredTypeHandlerName(blockName) {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setUnregisteredFallbackBlockName(blockName);
}
/**
...
function getUnregisteredTypeHandlerName() {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getUnregisteredFallbackBlockName();
}
/**
...
function setDefaultBlockName(name) {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setDefaultBlockName(name);
}
/**
...
function setGroupingBlockName(name) {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setGroupingBlockName(name);
}
/**
...
function getDefaultBlockName() {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getDefaultBlockName();
}
/**
...
function getBlockTypes() {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockTypes();
}
/**
...
function getBlockSupport(nameOrType, feature, defaultSupports) {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
function hasBlockSupport(nameOrType, feature, defaultSupports) {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).hasBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
const getChildBlockNames = blockName => {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getChildBlockNames(blockName);
};
/**
...
const hasChildBlocks = blockName => {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).hasChildBlocks(blockName);
};
/**
...
const hasChildBlocksWithInserterSupport = blockName => {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).hasChildBlocksWithInserterSupport(blockName);
};
/**
...
const registerBlockStyle = (blockName, styleVariation) => {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).addBlockStyles(blockName, styleVariation);
};
/**
...
const unregisterBlockStyle = (blockName, styleVariationName) => {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).removeBlockStyles(blockName, styleVariationName);
};
/**
...
const getBlockVariations = (blockName, scope) => {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)(_store__WEBPACK_IMPORTED_MODULE_2__.store).getBlockVariations(blockName, scope);
};
/**
...
const registerBlockVariation = (blockName, variation) => {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).addBlockVariations(blockName, variation);
};
/**
...
const unregisterBlockVariation = (blockName, variationName) => {
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).removeBlockVariations(blockName, variationName);
};
...
/* harmony import */ var _parser_serialize_raw_block__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parser/serialize-raw-block */ "./node_modules/@wordpress/blocks/build-module/api/parser/serialize-raw-block.js");
...
function getBlockProps(props = {}) {
  ...
  return getBlockProps.skipFilters ? props : (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.applyFilters)('blocks.getSaveContent.extraProps', { ...props
...
function getSaveElement(blockTypeOrName, attributes, innerBlocks = []) {
  ...
  if (element !== null && typeof element === 'object' && (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.hasFilter)('blocks.getSaveContent.extraProps') && !(blockType.apiVersion > 1)) {
     ...
     * @param {Object}  attributes Block attributes.
     */
    const props = (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.applyFilters)('blocks.getSaveContent.extraProps', { ...element.props
    }, blockType, attributes);
...
function serializeBlock(block, {
  ...
  if (!block.isValid && block.__unstableBlockSource) {
    return (0,_parser_serialize_raw_block__WEBPACK_IMPORTED_MODULE_5__.serializeRawBlock)(block.__unstableBlockSource);
  }

  const blockName = block.name;
  const saveContent = getBlockInnerHTML(block);

  if (blockName === (0,_registration__WEBPACK_IMPORTED_MODULE_6__.getUnregisteredTypeHandlerName)() || !isInnerBlocks && blockName === (0,_registration__WEBPACK_IMPORTED_MODULE_6__.getFreeformContentHandlerName)()) {
    return saveContent;
  }

  const blockType = (0,_registration__WEBPACK_IMPORTED_MODULE_6__.getBlockType)(blockName);
...
function __unstableSerializeAndClean(blocks) {
  ...
  if (blocks.length === 1 && (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isUnmodifiedDefaultBlock)(blocks[0])) {
    blocks = [];
  }
  ...
  if (blocks.length === 1 && blocks[0].name === (0,_registration__WEBPACK_IMPORTED_MODULE_6__.getFreeformContentHandlerName)() && blocks[0].name === 'core/freeform') {
...
/* harmony export */   "isUnmodifiedBlock": function() { return /* binding */ isUnmodifiedBlock; },
...
/* harmony import */ var colord_plugins_names__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! colord/plugins/names */ "./node_modules/colord/plugins/names.mjs");
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./constants */ "./node_modules/@wordpress/blocks/build-module/api/constants.js");
...
(0,colord__WEBPACK_IMPORTED_MODULE_3__.extend)([colord_plugins_names__WEBPACK_IMPORTED_MODULE_4__["default"], colord_plugins_a11y__WEBPACK_IMPORTED_MODULE_5__["default"]]);
/**
...
function isUnmodifiedBlock(block) {
  ...
  if (!isUnmodifiedBlock[block.name]) {
    isUnmodifiedBlock[block.name] = (0,_factory__WEBPACK_IMPORTED_MODULE_6__.createBlock)(block.name);
  }

  const newBlock = isUnmodifiedBlock[block.name];
  const blockType = (0,_registration__WEBPACK_IMPORTED_MODULE_7__.getBlockType)(block.name);
...
function isUnmodifiedDefaultBlock(block) {
  return block.name === (0,_registration__WEBPACK_IMPORTED_MODULE_7__.getDefaultBlockName)() && isUnmodifiedBlock(block);
}
/**
...
function normalizeIconObject(icon) {
  icon = icon || _constants__WEBPACK_IMPORTED_MODULE_8__.BLOCK_ICON_DEFAULT;
  ...
  if ('background' in icon) {
    const colordBgColor = (0,colord__WEBPACK_IMPORTED_MODULE_3__.colord)(icon.background);
...
function __experimentalGetBlockAttributesNamesByRole(name, role) {
  const attributes = (0,_registration__WEBPACK_IMPORTED_MODULE_7__.getBlockType)(name)?.attributes;
...
const processBlockType = (blockType, {
  ...
  const settings = (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.applyFilters)('blocks.registerBlockType', { ...blockType
  }, name, null);

  if (settings.description && typeof settings.description !== 'string') {
    _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_1___default()('Declaring non-string block descriptions', {
      since: '6.2'
    });
  }
  ...
  if (settings.deprecated) {
    ...
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.applyFilters)('blocks.registerBlockType', // Merge deprecation keys with pre-filter settings
    ...
    { // Omit deprecation keys here so that deprecations
      ...
      ...deprecation
    }, name, deprecation)).filter(([key]) => _api_constants__WEBPACK_IMPORTED_MODULE_4__.DEPRECATED_ENTRY_KEYS.includes(key))));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSupportedStyles": function() { return /* binding */ getSupportedStyles; }
/* harmony export */ });
/* harmony import */ var rememo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rememo */ "./node_modules/rememo/rememo.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectors */ "./node_modules/@wordpress/blocks/build-module/store/selectors.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/blocks/build-module/store/utils.js");
...
const getSupportedStyles = (0,rememo__WEBPACK_IMPORTED_MODULE_0__["default"])((state, name, element) => {
  ...
  const blockType = (0,_selectors__WEBPACK_IMPORTED_MODULE_1__.getBlockType)(state, name);
  ...
  Object.keys(_api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY).forEach(styleName => {
    if (!_api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY[styleName].support) {
      return;
    ...
    if (_api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY[styleName].requiresOptOut) {
      if (_api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY[styleName].support[0] in blockType.supports && (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getValueFromObjectPath)(blockType.supports, _api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY[styleName].support) !== false) {
        supportKeys.push(styleName);
        return;
      }
    }

    if ((0,_utils__WEBPACK_IMPORTED_MODULE_3__.getValueFromObjectPath)(blockType.supports, _api_constants__WEBPACK_IMPORTED_MODULE_2__.__EXPERIMENTAL_STYLE_PROPERTY[styleName].support, false)) {
      supportKeys.push(styleName);
    }
  });
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _api_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api/utils */ "./node_modules/@wordpress/blocks/build-module/api/utils.js");
/**
 * WordPress dependencies
 */
...
function unprocessedBlockTypes(state = {}, action) {
  switch (action.type) {
    ...
    case 'REMOVE_BLOCK_TYPES':
      return (0,_api_utils__WEBPACK_IMPORTED_MODULE_2__.omit)(state, action.names);
  }
...
function collections(state = {}, action) {
  switch (action.type) {
    ...
    case 'REMOVE_BLOCK_COLLECTION':
      return (0,_api_utils__WEBPACK_IMPORTED_MODULE_2__.omit)(state, action.namespace);
  }
...
/* harmony export */   "__experimentalHasContentRoleAttribute": function() { return /* binding */ __experimentalHasContentRoleAttribute; },
...
const getBlockSupport = (state, nameOrType, feature, defaultSupports) => {
  ...
  return (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getValueFromObjectPath)(blockType.supports, feature, defaultSupports);
};
/**
 * Returns true if the block defines support for a feature, or false otherwise.
 *
...
function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  const blockType = getNormalizedBlockType(state, nameOrType);
  const getNormalizedSearchTerm = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pipe)([// Disregard diacritics.
  //  Input: "média"
  ...
  const isSearchMatch = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pipe)([getNormalizedSearchTerm, normalizedCandidate => normalizedCandidate.includes(normalizedSearchTerm)]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getValueFromObjectPath": function() { return /* binding */ getValueFromObjectPath; }
/* harmony export */ });
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rng.js */ "./node_modules/@wordpress/blocks/node_modules/uuid/dist/esm-browser/rng.js");
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stringify.js */ "./node_modules/@wordpress/blocks/node_modules/uuid/dist/esm-browser/stringify.js");
...
/* harmony export */   "isUnmodifiedBlock": function() { return /* reexport safe */ _api__WEBPACK_IMPORTED_MODULE_1__.isUnmodifiedBlock; },
...
/* harmony export */   "withBlockContentContext": function() { return /* reexport safe */ _deprecated__WEBPACK_IMPORTED_MODULE_2__.withBlockContentContext; }
/* harmony export */ });
