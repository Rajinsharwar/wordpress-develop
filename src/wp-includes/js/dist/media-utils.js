...
async function uploadMedia({
  ...
  const setAndUpdateFiles = (idx, value) => {
    (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_1__.revokeBlobURL)(filesSet[idx]?.url);
    filesSet[idx] = value;
  ...
  for (const mediaFile of files) {
    ...
    if (allowedMimeTypesForUser && mediaFile.type && !isAllowedMimeTypeForUser(mediaFile.type)) {
      onError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( // translators: %s: file name.
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('%s: Sorry, you are not allowed to upload this file type.'), mediaFile.name),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.type && !isAllowedType(mediaFile.type)) {
      onError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( // translators: %s: file name.
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('%s: Sorry, this file type is not supported here.'), mediaFile.name),
        file: mediaFile
      });
      continue;
    ...
    if (maxUploadFileSize && mediaFile.size > maxUploadFileSize) {
      onError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( // translators: %s: file name.
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('%s: This file exceeds the maximum upload size for this site.'), mediaFile.name),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.size <= 0) {
      onError({
        code: 'EMPTY_FILE',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( // translators: %s: file name.
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('%s: This file is empty.'), mediaFile.name),
        file: mediaFile
      });
      continue;
    }
  ...
  for (let idx = 0; idx < validFiles.length; ++idx) {
    ...
    try {
      ...
      if (error.message) {
        ...
        message = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( // translators: %s: file name
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Error while uploading file %s to the media library.'), mediaFile.name);
      }
