...
/* harmony export */   "receiveNavigationFallbackId": function() { return /* binding */ receiveNavigationFallbackId; },
/* harmony export */   "receiveThemeGlobalStyleRevisions": function() { return /* binding */ receiveThemeGlobalStyleRevisions; },
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! uuid */ "./node_modules/@wordpress/core-data/node_modules/uuid/dist/esm-browser/v4.js");
...
/* harmony import */ var _batch__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./batch */ "./node_modules/@wordpress/core-data/build-module/batch/create-batch.js");
...
/* harmony import */ var _private_selectors__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./private-selectors */ "./node_modules/@wordpress/core-data/build-module/private-selectors.js");
/**
...
const undo = () => ({
  ...
  const undoEdit = select(state => (0,_private_selectors__WEBPACK_IMPORTED_MODULE_7__.getUndoEdits)(state.root));
...
const redo = () => ({
  ...
  // Todo: we shouldn't have to pass "root" here.
  const redoEdit = select(state => (0,_private_selectors__WEBPACK_IMPORTED_MODULE_7__.getRedoEdits)(state.root));
...
const saveEntityRecord = (kind, name, record, {
  ...
  const lock = await dispatch.__unstableAcquireStoreLock(_name__WEBPACK_IMPORTED_MODULE_6__.STORE_NAME, ['entities', 'records', kind, name, recordId || (0,uuid__WEBPACK_IMPORTED_MODULE_8__["default"])()], {
    exclusive: true
  });
...
const __experimentalBatch = requests => async ({
  ...
  const batch = (0,_batch__WEBPACK_IMPORTED_MODULE_9__["default"])();
  const api = {
...
/* harmony export */ });
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! change-case */ "./node_modules/capital-case/dist.es2015/index.js");
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! change-case */ "./node_modules/pascal-case/dist.es2015/index.js");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
...
const rootEntitiesConfig = [{
  ...
  getTitle: record => {
    ...
    return (_record$title = record?.title) !== null && _record$title !== void 0 ? _record$title : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Site Title');
  }
}, {
  ...
  return Object.entries(postTypes !== null && postTypes !== void 0 ? postTypes : {}).map(([name, postType]) => {
    ...
    return {
      ...
      getTitle: record => {
        ...
        return record?.title?.rendered || record?.title || (isTemplate ? (0,change_case__WEBPACK_IMPORTED_MODULE_2__.capitalCase)((_record$slug = record.slug) !== null && _record$slug !== void 0 ? _record$slug : '') : String(record.id));
      },
...
const getMethodName = (kind, name, prefix = 'get', usePlural = false) => {
  ...
  const kindPrefix = kind === 'root' ? '' : (0,change_case__WEBPACK_IMPORTED_MODULE_3__.pascalCase)(kind);
  const nameSuffix = (0,change_case__WEBPACK_IMPORTED_MODULE_3__.pascalCase)(name) + (usePlural ? 's' : '');
  const suffix = usePlural && 'plural' in entityConfig && entityConfig?.plural ? (0,change_case__WEBPACK_IMPORTED_MODULE_3__.pascalCase)(entityConfig.plural) : nameSuffix;
...
const getOrLoadEntitiesConfig = kind => async ({
  ...
  dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.addEntities)(configs));
  return configs;
};
...
/* harmony import */ var _private_apis__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./private-apis */ "./node_modules/@wordpress/core-data/build-module/private-apis.js");
...
const entityContexts = { ..._entities__WEBPACK_IMPORTED_MODULE_4__.rootEntitiesConfig.reduce((acc, loader) => {
    if (!acc[loader.kind]) {
      acc[loader.kind] = {};
    }
  ...
  ..._entities__WEBPACK_IMPORTED_MODULE_4__.additionalEntityConfigLoaders.reduce((acc, loader) => {
    acc[loader.kind] = {};
    return acc;
  }, {})
};
...
function useEntityProp(kind, name, prop, _id) {
  ...
  const {
    ...
    } = select(_name__WEBPACK_IMPORTED_MODULE_5__.STORE_NAME);
  ...
  const {
    editEntityRecord
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useDispatch)(_name__WEBPACK_IMPORTED_MODULE_5__.STORE_NAME);
...
function useEntityBlockEditor(kind, name, {
  ...
  const updateFootnotes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(_blocks => {
    const output = {
      blocks: _blocks
    };
    ...
    const {
      getRichTextValues
    } = (0,_private_apis__WEBPACK_IMPORTED_MODULE_6__.unlock)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.privateApis);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "__experimentalUseEntityRecord": function() { return /* reexport safe */ _use_entity_record__WEBPACK_IMPORTED_MODULE_0__.__experimentalUseEntityRecord; },
/* harmony export */   "__experimentalUseEntityRecords": function() { return /* reexport safe */ _use_entity_records__WEBPACK_IMPORTED_MODULE_1__.__experimentalUseEntityRecords; },
/* harmony export */   "__experimentalUseResourcePermissions": function() { return /* reexport safe */ _use_resource_permissions__WEBPACK_IMPORTED_MODULE_2__.__experimentalUseResourcePermissions; },
/* harmony export */   "useEntityRecord": function() { return /* reexport safe */ _use_entity_record__WEBPACK_IMPORTED_MODULE_0__["default"]; },
/* harmony export */   "useEntityRecords": function() { return /* reexport safe */ _use_entity_records__WEBPACK_IMPORTED_MODULE_1__["default"]; },
/* harmony export */   "useResourcePermissions": function() { return /* reexport safe */ _use_resource_permissions__WEBPACK_IMPORTED_MODULE_2__["default"]; }
/* harmony export */ });
...
/* harmony default export */ __webpack_exports__["default"] = (memize__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "__experimentalUseEntityRecord": function() { return /* binding */ __experimentalUseEntityRecord; },
/* harmony export */   "default": function() { return /* binding */ useEntityRecord; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "__experimentalUseEntityRecords": function() { return /* binding */ __experimentalUseEntityRecords; },
/* harmony export */   "default": function() { return /* binding */ useEntityRecords; }
/* harmony export */ });
...
function useEntityRecords(kind, name, queryArgs = {}, options = {
  ...
  const {
    data: records,
    ...rest
  } = (0,_use_query_select__WEBPACK_IMPORTED_MODULE_3__["default"])(query => {
    if (!options.enabled) {
      return {
    ...
    return query(___WEBPACK_IMPORTED_MODULE_2__.store).getEntityRecords(kind, name, queryArgs);
...
/* harmony export */   "default": function() { return /* binding */ useQuerySelect; }
/* harmony export */ });
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "__experimentalUseResourcePermissions": function() { return /* binding */ __experimentalUseResourcePermissions; },
/* harmony export */   "default": function() { return /* binding */ useResourcePermissions; }
/* harmony export */ });
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants */ "./node_modules/@wordpress/core-data/build-module/hooks/constants.js");
...
function useResourcePermissions(resource, id) {
  return (0,_use_query_select__WEBPACK_IMPORTED_MODULE_2__["default"])(resolve => {
    const {
      canUser
    } = resolve(___WEBPACK_IMPORTED_MODULE_1__.store);
    ...
    if (!id) {
      ...
      let status = _constants__WEBPACK_IMPORTED_MODULE_3__.Status.Idle;

      if (isResolving) {
        status = _constants__WEBPACK_IMPORTED_MODULE_3__.Status.Resolving;
      } else if (hasResolved) {
        status = _constants__WEBPACK_IMPORTED_MODULE_3__.Status.Success;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EntityProvider": function() { return /* reexport safe */ _entity_provider__WEBPACK_IMPORTED_MODULE_10__["default"]; },
...
/* harmony export */   "__experimentalUseEntityRecord": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.__experimentalUseEntityRecord; },
/* harmony export */   "__experimentalUseEntityRecords": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.__experimentalUseEntityRecords; },
/* harmony export */   "__experimentalUseResourcePermissions": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.__experimentalUseResourcePermissions; },
/* harmony export */   "store": function() { return /* binding */ store; },
/* harmony export */   "useEntityBlockEditor": function() { return /* reexport safe */ _entity_provider__WEBPACK_IMPORTED_MODULE_10__.useEntityBlockEditor; },
/* harmony export */   "useEntityId": function() { return /* reexport safe */ _entity_provider__WEBPACK_IMPORTED_MODULE_10__.useEntityId; },
/* harmony export */   "useEntityProp": function() { return /* reexport safe */ _entity_provider__WEBPACK_IMPORTED_MODULE_10__.useEntityProp; },
/* harmony export */   "useEntityRecord": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.useEntityRecord; },
/* harmony export */   "useEntityRecords": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.useEntityRecords; },
/* harmony export */   "useResourcePermissions": function() { return /* reexport safe */ _hooks__WEBPACK_IMPORTED_MODULE_12__.useResourcePermissions; }
/* harmony export */ });
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _private_apis__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./private-apis */ "./node_modules/@wordpress/core-data/build-module/private-apis.js");
/* harmony import */ var _private_selectors__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./private-selectors */ "./node_modules/@wordpress/core-data/build-module/private-selectors.js");
/* harmony import */ var _entity_provider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./entity-provider */ "./node_modules/@wordpress/core-data/build-module/entity-provider.js");
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hooks */ "./node_modules/@wordpress/core-data/build-module/hooks/index.js");
/**
 * WordPress dependencies
 */
...
(0,_private_apis__WEBPACK_IMPORTED_MODULE_8__.unlock)(store).registerPrivateSelectors({
  getNavigationFallbackId: _private_selectors__WEBPACK_IMPORTED_MODULE_9__.getNavigationFallbackId
});
...
const {
  lock,
  unlock
} = (0,_wordpress_private_apis__WEBPACK_IMPORTED_MODULE_0__.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next WordPress release.', '@wordpress/core-data');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getNavigationFallbackId": function() { return /* binding */ getNavigationFallbackId; },
/* harmony export */   "getRedoEdits": function() { return /* binding */ getRedoEdits; },
/* harmony export */   "getUndoEdits": function() { return /* binding */ getUndoEdits; }
/* harmony export */ });
/**
 * Internal dependencies
 */
...
const receiveQueries = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.compose)([// Limit to matching action type so we don't attempt to replace action on
// an unhandled action.
...
(0,_utils__WEBPACK_IMPORTED_MODULE_7__["default"])('stableKey')])((state = null, action) => {
  const {
    type,
    page,
    perPage,
...
const getQueriedItems = (0,rememo__WEBPACK_IMPORTED_MODULE_0__["default"])((state, query = {}) => {
...
/* harmony export */   "navigationFallbackId": function() { return /* binding */ navigationFallbackId; },
...
/* harmony export */   "themeGlobalStyleRevisions": function() { return /* binding */ themeGlobalStyleRevisions; },
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/core-data/build-module/utils/if-matching-action.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/core-data/build-module/utils/replace-action.js");
/* harmony import */ var _queried_data__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./queried-data */ "./node_modules/@wordpress/core-data/build-module/queried-data/reducer.js");
...
function entity(entityConfig) {
  return (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.compose)([withMultiEntityRecordEdits, // Limit to matching action type so we don't attempt to replace action on
  // an unhandled action.
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__["default"])(action => action.name && action.kind && action.name === entityConfig.name && action.kind === entityConfig.kind), // Inject the entity config into the action.
  (0,_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(action => {
    return { ...action,
      key: entityConfig.key || _entities__WEBPACK_IMPORTED_MODULE_6__.DEFAULT_ENTITY_KEY
    };
  })])((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.combineReducers)({
    queriedData: _queried_data__WEBPACK_IMPORTED_MODULE_7__["default"],
    edits: (state = {}, action) => {
        ...
        case 'RECEIVE_ITEMS':
          ...
          for (const record of action.items) {
            ...
            const nextEdits = Object.keys(edits).reduce((acc, key) => {
              ...
              // comparison.
              !fast_deep_equal_es6__WEBPACK_IMPORTED_MODULE_0___default()(edits[key], (_record$key$raw = record[key]?.raw) !== null && _record$key$raw !== void 0 ? _record$key$raw : record[key]) && ( // Sometimes the server alters the sent value which means
...
function entitiesConfig(state = _entities__WEBPACK_IMPORTED_MODULE_6__.rootEntitiesConfig, action) {
  switch (action.type) {
    case 'ADD_ENTITIES':
...
const entities = (state = {}, action) => {
  ...
  if (!entitiesDataReducer || newConfig !== state.config) {
    ...
    entitiesDataReducer = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.combineReducers)(Object.entries(entitiesByKind).reduce((memo, [kind, subEntities]) => {
      const kindReducer = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.combineReducers)(subEntities.reduce((kindMemo, entityConfig) => ({ ...kindMemo,
    ...
    case 'EDIT_ENTITY_RECORD':
      {
        ...
        if (!_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_3___default()(comparisonUndoEdits, comparisonEdits)) {
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.combineReducers)({
  terms,
  users,
  currentTheme,
...
/* harmony export */   "getCurrentThemeGlobalStylesRevisions": function() { return /* binding */ getCurrentThemeGlobalStylesRevisions; },
...
/* harmony export */ });
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! change-case */ "./node_modules/camel-case/dist.es2015/index.js");
/* harmony import */ var _wordpress_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/url */ "@wordpress/url");
/* harmony import */ var _wordpress_url__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_url__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./entities */ "./node_modules/@wordpress/core-data/build-module/entities.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/core-data/build-module/utils/forward-resolver.js");
/**
 * External dependencies
 */
...
const getAuthors = query => async ({
  ...
  const users = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
    path
  });
...
const getCurrentUser = () => async ({
  ...
  const currentUser = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
    path: '/wp/v2/users/me'
  });
...
const getEntityRecord = (kind, name, key = '', query) => async ({
  ...
  const configs = await dispatch((0,_entities__WEBPACK_IMPORTED_MODULE_2__.getOrLoadEntitiesConfig)(kind));
  ...
  try {
    if (query !== undefined && query._fields) {
      ...
      // the ID.
      query = { ...query,
        _fields: [...new Set([...((0,_utils__WEBPACK_IMPORTED_MODULE_4__["default"])(query._fields) || []), entityConfig.key || _entities__WEBPACK_IMPORTED_MODULE_2__.DEFAULT_ENTITY_KEY])].join()
      };
    ...
    const path = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_0__.addQueryArgs)(entityConfig.baseURL + (key ? '/' + key : ''), { ...entityConfig.baseURLParams,
      ...query
    });
    ...
    const record = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      path
    });
...
const getRawEntityRecord = (0,_utils__WEBPACK_IMPORTED_MODULE_5__["default"])('getEntityRecord');
/**
 * Requests an entity's record from the REST API.
 */

const getEditedEntityRecord = (0,_utils__WEBPACK_IMPORTED_MODULE_5__["default"])('getEntityRecord');
/**
...
const getEntityRecords = (kind, name, query = {}) => async ({
  ...
  try {
    ...
    const path = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_0__.addQueryArgs)(entityConfig.baseURL, { ...entityConfig.baseURLParams,
      ...query
    });
    let records = Object.values(await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      path
    ...
    if (!query?._fields && !query.context) {
      const key = entityConfig.key || _entities__WEBPACK_IMPORTED_MODULE_2__.DEFAULT_ENTITY_KEY;
...
const getThemeSupports = (0,_utils__WEBPACK_IMPORTED_MODULE_5__["default"])('getCurrentTheme');
/**
...
const getEmbedPreview = url => async ({
  ...
  try {
    const embedProxyResponse = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
const getAutosaves = (postType, postId) => async ({
  ...
  const autosaves = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
const __experimentalGetTemplateForLink = link => async ({
  ...
  try {
    ...
    template = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      url: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_0__.addQueryArgs)(link, {
...
const __experimentalGetCurrentGlobalStylesId = () => async ({
  ...
  if (globalStylesURL) {
    const globalStylesObject = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      url: globalStylesURL
    });
...
const __experimentalGetCurrentThemeBaseGlobalStyles = () => async ({
  ...
  const themeGlobalStyles = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
const getCurrentThemeGlobalStylesRevisions = () => async ({
  ...
  if (revisionsURL) {
    const resetRevisions = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      url: revisionsURL
    });
    const revisions = resetRevisions?.map(revision => Object.fromEntries(Object.entries(revision).map(([key, value]) => [(0,change_case__WEBPACK_IMPORTED_MODULE_6__.camelCase)(key), value])));
...
const getBlockPatterns = () => async ({
  ...
  const restPatterns = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
    path: '/wp/v2/block-patterns/patterns'
  });
  const patterns = restPatterns?.map(pattern => Object.fromEntries(Object.entries(pattern).map(([key, value]) => [(0,change_case__WEBPACK_IMPORTED_MODULE_6__.camelCase)(key), value])));
  dispatch({
...
const getBlockPatternCategories = () => async ({
  ...
  const categories = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
const getNavigationFallbackId = () => async ({
  ...
  const fallback = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/core-data/build-module/utils/set-nested-value.js");
...
const isRequestingEmbedPreview = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.createRegistrySelector)(select => (state, url) => {
  return select(_name__WEBPACK_IMPORTED_MODULE_4__.STORE_NAME).isResolving('getEmbedPreview', [url]);
});
/**
...
function getAuthors(state, query) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_3___default()("select( 'core' ).getAuthors()", {
    since: '5.9',
    alternative: "select( 'core' ).getUsers({ who: 'authors' })"
  });
  const path = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.addQueryArgs)('/wp/v2/users/?who=authors&per_page=100', query);
...
function getEntitiesByKind(state, kind) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_3___default()("wp.data.select( 'core' ).getEntitiesByKind()", {
    since: '6.0',
...
function getEntity(state, kind, name) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_3___default()("wp.data.select( 'core' ).getEntity()", {
    since: '6.0',
...
const getEntityRecord = (0,rememo__WEBPACK_IMPORTED_MODULE_0__["default"])((state, kind, name, key, query) => {
  ...
  if (item && query._fields) {
    ...
    const filteredItem = {};
    const fields = (_getNormalizedCommaSe = (0,_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(query._fields)) !== null && _getNormalizedCommaSe !== void 0 ? _getNormalizedCommaSe : [];
    ...
    for (let f = 0; f < fields.length; f++) {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_6__["default"])(filteredItem, field, value);
    }
...
function getUndoEdit(state) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_3___default()("select( 'core' ).getUndoEdit()", {
    since: '6.3'
  });
...
function getRedoEdit(state) {
  _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_3___default()("select( 'core' ).getRedoEdit()", {
    since: '6.3'
  });
...
function hasUndo(state) {
  return Boolean((0,_private_selectors__WEBPACK_IMPORTED_MODULE_10__.getUndoEdits)(state));
}
/**
...
function hasRedo(state) {
  return Boolean((0,_private_selectors__WEBPACK_IMPORTED_MODULE_10__.getRedoEdits)(state));
}
/**
...
const hasFetchedAutosaves = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.createRegistrySelector)(select => (state, postType, postId) => {
  return select(_name__WEBPACK_IMPORTED_MODULE_4__.STORE_NAME).hasFinishedResolution('getAutosaves', [postType, postId]);
});
/**
...
const getReferenceByDistinctEdits = (0,rememo__WEBPACK_IMPORTED_MODULE_0__["default"])( // This unused state argument is listed here for the documentation generating tool (docgen).
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ setNestedValue; }
/* harmony export */ });
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rng.js */ "./node_modules/@wordpress/core-data/node_modules/uuid/dist/esm-browser/rng.js");
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stringify.js */ "./node_modules/@wordpress/core-data/node_modules/uuid/dist/esm-browser/stringify.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "capitalCase": function() { return /* binding */ capitalCase; },
/* harmony export */   "capitalCaseTransform": function() { return /* binding */ capitalCaseTransform; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "upperCaseFirst": function() { return /* binding */ upperCaseFirst; }
/* harmony export */ });
/**
