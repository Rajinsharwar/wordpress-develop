...
const useDispatchWithMap = (dispatchMap, deps) => {
  ...
  const currentDispatchMap = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(dispatchMap);
...
function useMappingSelect(suspense, mapSelect, deps) {
  ...
  const store = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => Store(registry, suspense), [registry]);
...
const withDispatch = mapDispatchToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(WrappedComponent => ownProps => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(WrappedComponent, { ...ownProps,
    ...dispatchProps
  });
}, 'withDispatch');
...
const withRegistry = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(OriginalComponent => props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_registry_provider__WEBPACK_IMPORTED_MODULE_2__.RegistryConsumer, null, registry => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(OriginalComponent, { ...props,
  registry: registry
})), 'withRegistry');
...
const withSelect = mapSelectToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(WrappedComponent => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.pure)(ownProps => {
...
/* harmony export */   "dispatch": function() { return /* reexport safe */ _dispatch__WEBPACK_IMPORTED_MODULE_13__.dispatch; },
/* harmony export */   "plugins": function() { return /* reexport module object */ _plugins__WEBPACK_IMPORTED_MODULE_15__; },
...
/* harmony export */   "select": function() { return /* reexport safe */ _select__WEBPACK_IMPORTED_MODULE_14__.select; },
...
/* harmony export */   "useSuspenseSelect": function() { return /* reexport safe */ _components_use_select__WEBPACK_IMPORTED_MODULE_6__.useSuspenseSelect; },
...
/* harmony import */ var _wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/redux-routine */ "@wordpress/redux-routine");
/* harmony import */ var _wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_2__);
...
function createReduxStore(key, options) {
  ...
  const storeDescriptor = {
    ...
    instantiate: registry => {
      ...
      const actions = { ...mapValues(_metadata_actions__WEBPACK_IMPORTED_MODULE_5__, bindAction),
      ...
      const selectors = { ...mapValues(_metadata_selectors__WEBPACK_IMPORTED_MODULE_6__, bindMetadataSelector),
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  ...
  return (0,redux__WEBPACK_IMPORTED_MODULE_11__.createStore)(enhancedReducer, {
    root: initialState
  }, (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.compose)(enhancers));
}
/**
